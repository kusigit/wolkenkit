...
const getNotificationsFieldConfiguration = function ({ application, notificationEmitter }) {
    ...
    const notificationGraphQl = get_graphql_from_jsonschema_1.getGraphqlFromJsonSchema({
    ...
    return {
        type: graphql_1.buildSchema(notificationGraphQl.typeDefinitions.join('\n')).getType(notificationGraphQl.typeName),
        description,
