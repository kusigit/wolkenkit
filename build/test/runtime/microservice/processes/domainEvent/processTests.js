...
suite('domain event process', function () {
    this.timeout(60000);
    const applicationDirectory = getTestApplicationDirectory_1.getTestApplicationDirectory({ name: 'base' }), pubSubChannelForNewDomainEvents = 'newDomainEvent', pubSubChannelNotification = 'notification';
