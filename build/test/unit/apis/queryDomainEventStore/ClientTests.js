    ...
    suite('/v2', () => {
        ...
        suite('getReplay', () => {
            ...
            test('throws an error if the parameter fromTimestamp is less than 0.', async () => {
                ...
                await assertthat_1.assert.that(async () => await client.getReplay({ fromTimestamp: -1 })).is.throwingAsync((ex) => ex.code === errors_1.errors.ParameterInvalid.code && ex.message === `Parameter 'fromTimestamp' must be at least 0.`);
            });
        });
        suite('getReplayForAggregate', () => {
            ...
            test('throws an error if the parameter fromRevision is less than 1.', async () => {
                ...
                await assertthat_1.assert.that(async () => await client.getReplayForAggregate({ aggregateId: uuid_1.v4(), fromRevision: 0 })).is.throwingAsync((ex) => ex.code === errors_1.errors.ParameterInvalid.code && ex.message === `Parameter 'fromRevision' must be at least 1.`);
            });
            test('throws an error if the parameter toRevision is less than 1.', async () => {
                ...
                await assertthat_1.assert.that(async () => await client.getReplayForAggregate({ aggregateId: uuid_1.v4(), toRevision: 0 })).is.throwingAsync((ex) => ex.code === errors_1.errors.ParameterInvalid.code && ex.message === `Parameter 'toRevision' must be at least 1.`);
            });
            test(`throws an error if the parameter 'fromRevision' is greater than 'toRevision'.`, async () => {
                ...
                await assertthat_1.assert.that(async () => await client.getReplayForAggregate({ aggregateId: uuid_1.v4(), fromRevision: 5, toRevision: 3 })).is.throwingAsync((ex) => ex.code === errors_1.errors.ParameterInvalid.code && ex.message === `Parameter 'toRevision' must be greater or equal to 'fromRevision'.`);
            });
        });
